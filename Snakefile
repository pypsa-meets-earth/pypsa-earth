...
rule prepare_sector_network:
    params:
        ...
        h2_underground_storage=config["sector"]["hydrogen"]["underground_storage"],
        h2_underground=config["custom_data"]["h2_underground"],
        h2_network=config["sector"]["hydrogen"]["network"],
        countries=config["countries"],
        gas_network_repurposing=config["sector"]["hydrogen"]["gas_network_repurposing"],
