...
- [Training playlist](https://www.youtube.com/playlist?list=PLz1RcE1NdLlEzCT8G_v-sJKOeHOhZvw5R)
- [Presentation playlist](https://www.youtube.com/playlist?list=PLz1RcE1NdLlHpsyopZUKDkeyAuQotfOE7)
- [Youtube channel](https://www.youtube.com/@pypsameetsearth7475/featured)
...
- [Here](https://www.youtube.com/watch?v=8JJ101D3knE) a great intro which we recommend
...
We can recommend setting up VScode from Microsoft. Add some extension if you like as described in [this video](https://www.youtube.com/watch?v=0fROnrISdZU). For instance GitHub, Gitlense, and maybe some others.

*Note*: if you decide to use Visual Studio Code, check out the tutorial about how to use [Git](https://code.visualstudio.com/docs/editor/versioncontrol#_git-support) and [Github](https://code.visualstudio.com/docs/editor/github)  in Visual Studio Code
