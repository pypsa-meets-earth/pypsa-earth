...
- [PyPSA Distribution](https://github.com/pypsa-meets-earth/pypsa-distribution) is an optimization model for micro-grids and distribution grids with an automated extraction of the inputs needed to build grid topology and electricity load profiles
...
- [PyPSA Earth Status](https://github.com/pypsa-meets-earth/pypsa-earth-status) enables a reproducible workflow to validate PyPSA networks against real-world energy system data
...
- Regional Coordinators: Virio Andreyana, Tosin George, Emre Yorat
