...
- `Watch <https://www.youtube.com/watch?v=mAwhQnNRIvs>`_ and get hands-on to make PyPSA-Eur work on your computer (1-3h)
...
- To see what data we can extract, we work usually closely with the `basic PyPSA documentation <https://docs.pypsa.org/latest/user-guide/user-guide/>`_
