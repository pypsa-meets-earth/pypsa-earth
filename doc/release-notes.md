...
* Load transmission line type mappings from CSV files and add Australian custom mapping [PR # 1933](https://github.com/pypsa-meets-earth/pypsa-earth/pull/1933)
