...
* Fix handling of ``solid_biomass_potential`` and ``biogas_potential``. Improved spatial distribution of biomass and biogas potential [PR #1736](https://github.com/pypsa-meets-earth/pypsa-earth/pull/1736)
