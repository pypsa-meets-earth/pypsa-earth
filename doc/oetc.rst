...
The OETC platform enables PyPSA-Earth to utilize cloud computing infrastructure for
optimizing energy system models. This feature allows users to offload computationally
intensive optimization tasks to remote servers when their local machines lack sufficient
processing power.

.. note::

   Using OETC is **optional** and not required to run PyPSA-Earth.
...
within the PyPSA-Earth solving configuration.
...
To use OETC with PyPSA-Earth, you need to:
...
Once configured, OETC integration works transparently with the standard PyPSA-Earth
workflow. If a oetc configuration is present, PyPSA-Earth will automatically use
...
.. code-block:: console
    ...
    INFO:linopy.oetc:OETC - Job 992616b6-0f24-4ab5-8675-ba8098d795fa status: RUNNING, checking again in 45 seconds...
