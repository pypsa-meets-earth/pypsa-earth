...
Documentation for all options is currently being updated in [config].
...
You need to have installed PyPSA-Earth using the instructions provided in the [installation] section.
...
the [model_customization] for more information on how to customize the model.
```
