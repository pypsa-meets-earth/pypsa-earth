...
``
    ...
    For more information on the configuration file, please refer to the [config] section.
...
you can explore the `examples section in the PyPSA framework documentation](https://pypsa.readthedocs.io/en/latest/getting-started/quick-start.html).
...
!!! note
  ...
  `How to create a model for you region of interest with PyPSA-Earth?](https://github.com/pypsa-meets-earth/pypsa-earth/discussions/505)

[model_customization] section elaborates on building and running a full PyPSA-Earth model.
