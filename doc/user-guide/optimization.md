...
$$
\begin{aligned}
       \min_{x,\,\{y_\omega\}*{\omega\in\Omega}} \quad &
       f(x) + \sum*{\omega \in \Omega} p_\omega \, g(x, y_\omega, \omega) \label{eq:stoc_compact} \\
...
$$
\begin{aligned}
       \min_{x,\,\{y_d\}*{d\in\mathcal{D}}} \quad &
       f(x) + \sum*{d \in \mathcal{D}} w_d \, g(x, y_d, d) \label{eq:repdays_obj} \\
...
- [Theory of convex optimization] – book with everything about convex optimization

    S. P. Boyd, L. Vandenberghe, Convex Optimization, version 29 Edition, Cambridge University Press.

- [Theory of stochastic programming] - book with focus on stochastic programming
...
- [Game theory for energy systems] - course explaining stochastic programming in energy systems, with focus on electricity markets
...
- [Applications on PyPSA] - capacity expansion and economic dispatch models
