...
- Users are encouraged to contribute improvements back to the repository following contribution guidelines. See the [how to contribute guide](../community/contributing.md) for details.
...
4. Run PyPSA-Earth; the model will automatically use the custom datasets.
