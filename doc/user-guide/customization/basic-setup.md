...
To accurately model the temporal and spatial availability of renewables such as wind and solar energy, we process historical weather data using [atlite](https://atlite.readthedocs.io/en/latest/) package.
...
To delve into the specifics of the provided configurations and explore additional settings, please refer to the [configuration](../configuration.md) page.
