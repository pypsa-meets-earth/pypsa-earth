...
Moreover, networks can be solved for another focus with the derivative rules `solve_operations_network` for dispatch-only analyses on an already solved network.
