...
> **Note:** To understand the different distribution types and their parameters,
> check the [Scipy Documentation](https://docs.scipy.org/doc/scipy/reference/stats.html).
>
> **Tip:** To create realistic uncertainties, it is important to pay attention to
...
> **Tip:** Increasing the number of cores can make the process run faster. The number of cores can be increased by
...
See the [Monte Carlo API Reference](../api-reference/monte-carlo.md) for detailed function documentation.
