...
`pypsa-earth-cli` [pixi](https://pixi.sh) environment.
...
![PyPSA-Earth CLI main menu](https://raw.githubusercontent.com/pypsa-meets-earth/documentation/main/doc/img/pypsa_earth_cli_menu.png)
