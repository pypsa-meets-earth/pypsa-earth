...
Energy Statistics from UNSD (Terms of use):
...
Global Steel Plant from GlobalEnergyMonitor (License):
...
Petrochemicals Database For Europe And North America (Terms of use):
...
Global Oil Refinery Complex, Daily Capacity, CO2 Emissions and Various Ancillary Products Statistics from Esri-ArcGIS (License and Terms of use):
...
Global  Coal and Metal Mine Production Statistics (License):
The dataset is distributed under the licence Creative Commons Attribution 4.0 International (CC BY 4.0)

Pulp And Paper Mill Database For Latin America (Terms of use):
...
OurAirport Global Airport Statistics (Terms of use):
