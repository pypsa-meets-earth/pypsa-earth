...
def test_get_base_dir(get_temp_file):
    ...
    """
    assert get_base_dir(get_temp_file) == os.path.abspath(
        os.path.join(os.path.dirname(get_temp_file), os.pardir)
    )
    assert get_base_dir(__file__) == os.path.abspath(
...
def test_get_config_default_path(get_temp_file):
    ...
    assert get_config_default_path(base_dir) == str(
        get_path(base_dir, "config.default.yaml")
    )
