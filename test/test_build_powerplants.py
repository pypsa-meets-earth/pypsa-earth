...
from build_powerplants import add_custom_powerplants, replace_natural_gas_technology
...
# TODO: with minimal changes, this section can be re-enabled to test add_custom_powerplants
# @pytest.mark.parametrize(
#     "strategy,expected",
#     [("replace", (4, 19)), ("false", (34, 18)), ("merge", (38, 20))],
# )
# def test_add_custom_powerplants(get_config_dict, strategy, expected):
#     """
