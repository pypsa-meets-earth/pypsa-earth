...
if __name__ == "__main__":
    ...
    energy_totals["total road"] = (1-fuel_cell_share+electric_share) * efficiency_gains["total road ice"] * base_energy_totals["total road"] +\
        fuel_cell_share * efficiency_gains["total road fcev"] * base_energy_totals["total road"] +\
            electric_share * efficiency_gains["total road ev"] * base_energy_totals["total road"]
    
    energy_totals["total domestic navigation"] = (1-hydrogen_shipping_share) * efficiency_gains["total navigation oil"] * base_energy_totals["total domestic navigation"] +\
        hydrogen_shipping_share * efficiency_gains["total navigation hydrogen"] * base_energy_totals["total domestic navigation"]

    energy_totals["total international navigation"] = (1-hydrogen_shipping_share) * efficiency_gains["total navigation oil"] * base_energy_totals["total international navigation"] +\
        hydrogen_shipping_share * efficiency_gains["total navigation hydrogen"] * base_energy_totals["total international navigation"]
