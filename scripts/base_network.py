"""
Creates the network topology from a
`ENTSO-E map extract <https://github.com/PyPSA/GridKit/tree/master/entsoe>`_ (January 2020) as a PyPSA network.
...
def _load_buses_from_osm():
    buses = (
        pd.read_csv(snakemake.input.osm_buses)
        .set_index("bus_id")
