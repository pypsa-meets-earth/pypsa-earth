...
def override_values(tech, year, dr):
    ...
    if snakemake.wildcards["planning_horizons"] == 2050: 
        ...
        n_name = snakemake.input.network.split("/")[-1].replace(n.config["scenario"]["clusters"], "")
...
if __name__ == "__main__":
    ...
    if snakemake.config["custom_data"]["add_existing"] and snakemake.wildcards["planning_horizons"] == '2030':
