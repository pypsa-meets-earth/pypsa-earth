...
if __name__ == "__main__":
    if "snakemake" not in globals():
        ...
        snakemake = mock_snakemake(
            "build_industrial_production_per_country_tomorrow", planning_horizons=2030, demand='DF'
        )
    ...
    production = pd.read_csv(
        snakemake.input.industrial_production_per_country, index_col=0,keep_default_na=False
