...
def add_industry_heating(n, costs, market, scenario):
    ...
    carriers = [
        ...
        "solar linear fresnel reflector",
...
def attach_enhanced_geothermal(n, potential_fn, mode):
    ...
    # print(f"Annuity factor with capital cost: {annuity_factor_withcc}")
    # print(f"Annuity factor without capital cost: {annuity_factor}")
    # import sys
    # sys.exit()
