...
def add_co2(n, costs):
    ...
    cost_submarine = co2_links.underwater_fraction * \
        costs.at['CO2 submarine pipeline', 'fixed'] * co2_links.length
    ...
    if options['SMR']:
        ...
        n.madd("Link",
               ...
               efficiency3=costs.at['gas',
                                    'CO2 intensity'] * options["cc_fraction"],
...
# CARRIER = FOSSIL GAS
    ...
    n.madd("Link",
           ...
           p_nom_extendable=True,
           capital_cost=costs.at["cement capture",
                                 "fixed"] * costs.at['gas', 'CO2 intensity'],
           efficiency=0.9,
           efficiency2=costs.at['gas', 'CO2 intensity'] *
...
#     #tco2 per hour
    ...
    # check land tranport
    co2 = n.loads.loc[co2_release, "p_set"].sum() * costs.at["oil", 'CO2 intensity'] - \
        industrial_demand.loc[nodes,
                              "process emission from feedstock"].sum() / 8760
...
#     # remove today's industrial electricity demand by scaling down total electricity demand
    ...
    n.add("Load",
          ...
          carrier="process emissions",
          p_set=-industrial_demand.loc[nodes, ["process emission",
                                               "process emission from feedstock"]].sum(axis=1).sum() / 8760
          )
