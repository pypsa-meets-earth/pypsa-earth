...
test:
	...
	snakemake -c4 solve_all_networks_myopic --configfile config.tutorial.yaml test/config.myopic.yaml
...
clean:
	...
	snakemake -j1 solve_all_networks_myopic --delete-all-output --configfile config.tutorial.yaml test/config.myopic.yaml
