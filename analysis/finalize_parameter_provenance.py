...
TABLE_DIR = Path(
    "results/scenarios/thesis_tables"
)
...
OUTPUT_CSV = (
    TABLE_DIR
    / "table_04_parameter_provenance_FINAL.csv"
)

OUTPUT_TEX = (
    TABLE_DIR
    / "table_04_parameter_provenance_FINAL.tex"
)

SOURCE_CSV = (
    TABLE_DIR
    / "table_04_source_bibliography_seed.csv"
)

STATUS_CSV = (
    TABLE_DIR
    / "table_04_final_status_summary.csv"
)
...
CITATIONS = {
    ...
    "2045 annual electricity demand":
        "KAZENERGY2023NPP; KZMinEnergy2035",

    "Demand scaling factor":
        "KAZENERGY2023NPP; Parzen2022GlobalDemand",
    ...
    "Solar and onshore-wind expansion":
        "PyPSAEarth; IRENASTAT2023",

    "Transmission treatment":
        "PyPSAEarth; OpenStreetMap",
    ...
    "PEM LHV efficiency":
        "DanishEnergyAgencyRenewableFuels",
...
URLS = {
    ...
    "Existing conventional/hydro fleet":
        (
            "https://github.com/"
            "pypsa-meets-earth/pypsa-kz-data"
        ),
    ...
    "Mining electrical capacity":
        (
            "https://ar2021.kegoc.kz/pdf/"
            "AR2021_KEGOC_eng.pdf"
        ),
...
NOTES = {
    ...
    "Study region":
        (
            "Kazakhstan is the explicitly selected thesis "
            "system boundary."
        ),
    ...
    "Temporal resolution":
        (
            "Final scenarios use 8760 hourly snapshots."
        ),
    ...
    [
        {
            ...
            "Author / organisation":
                "KAZENERGY-hosted Kazakhstan Energy Week presentation",
            "Year": 2023,
            "Title":
                "Status and Progress of the NPP Programme in Kazakhstan",
            "Primary URL / DOI":
                (
                    "https://www.kazenergy.com/upload/document/"
                    "operation/forum/2023/"
            ...
            "Used for":
                "2045 electricity-demand planning/vision value",
            "Important location":
                "Slide 3",
        },

        {
            ...
            "Year": 2022,
            "Title":
                "Energy balance of the Republic of Kazakhstan to 2035",
            "Primary URL / DOI":
                (
            ...
            "Used for":
                "Independent official cross-check of 2035 demand",
            "Important location":
                "152.9 billion kWh by 2035",
        },

        {
            "Citation key": "Parzen2022GlobalDemand",
            "Author / organisation":
                "Parzen, Franken and Fioriti",
            "Year": 2022,
            "Title":
                (
            ...
            "Primary URL / DOI":
                "https://doi.org/10.5281/zenodo.6569890",
            "Used for":
                "PyPSA-Earth/GEGIS demand time-series basis",
            "Important location":
                "Zenodo version 0.0.3",
        },
...

        {
            ...
            "Author / organisation":
                "PyPSA meets Earth / Agora Energiewende / OET",
            "Year": 2024,
            "Title":
                "pypsa-kz-data",
            "Primary URL / DOI":
            ...
            "Used for":
                "Kazakhstan-specific powerplant dataset",
            "Important location":
...

        {
            ...
            "Year": 2023,
            "Title":
                "IRENASTAT renewable capacity statistics",
            "Primary URL / DOI":
                "https://pxweb.irena.org/",
            "Used for":
                "Existing renewable-capacity baseline",
            "Important location":
                "",
        },
...

        {
            ...
            "Used for":
                "Kazakhstan BTC-mining scale plausibility",
            "Important location":
                "Digital miners >1000 MW excluding shadow mining",
        },

        {
            "Citation key": "Stoll2019",
            "Author / organisation":
                "Stoll, Klaassen and Gallersdorfer",
            "Year": 2019,
            "Title":
            ...
            "Primary URL / DOI":
                "https://doi.org/10.1016/j.joule.2019.05.012",
            "Used for":
                "Mining energy/PUE methodological support",
            "Important location":
                "",
        },

        {
            ...
            "Used for":
                "Modern Bitcoin-mining operating context",
            "Important location":
                "",
        },
...

        {
            ...
            "Used for":
                "Dated BTC hashprice anchor",
            "Important location":
                (
                    "Spot 31.73; 7-day avg 32.31; "
                    "30-day avg 32.11 USD/PH/s/day"
                ),
        },
...

        {
            ...
            "Year": 2026,
            "Title":
                "HICP annual average inflation rates",
            "Primary URL / DOI":
                "https://ec.europa.eu/eurostat/",
            "Used for":
                "2021-2025 EUR inflation chain",
            "Important location":
...

        {
            ...
            "Primary URL / DOI":
                "https://doi.org/10.2765/0071034",
            "Used for":
                "2026 EU inflation assumption",
            "Important location":
                "EU inflation 2026 = 3.1%",
        },

        {
            ...
            "Year": 2022,
            "Title":
                "HYRASIA ONE Investment Agreement press release",
            "Primary URL / DOI":
                (
                    "https://hyrasia.one/wp-content/uploads/"
                    "2024/04/"
            ...
            "Used for":
                "Kazakhstan H2 system-scale plausibility",
            "Important location":
                "40 GW RES; 20 GW electrolysis; up to 2 MtH2/a",
        },

        {
            ...
            "Used for":
                "PEMEC technology parameter provenance",
            "Important location":
...

        {
            ...
            "Primary URL / DOI":
                "https://doi.org/10.1007/978-3-319-72459-1",
            "Used for":
                "PEM flexibility / system-integration support",
            "Important location":
                "",
        },
    ]
...
print(
    f"Value        : "
    f"{demand['Final value']} "
    f"{demand['Unit']}"
)

print(
    f"Status       : "
    f"{demand['Final status']}"
)

print(
    f"Citation     : "
    f"{demand['Citation key(s)']}"
)

print(
    f"Source       : "
    f"{demand['Primary URL / DOI']}"
)

print(
    f"Verification : "
    f"{demand['Verification note']}"
)
